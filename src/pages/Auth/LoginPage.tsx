      ...
      >
        <div className="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 p-8 md:p-12 border border-slate-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                ...
                <Link to="/forgot-password" title="Forgot Password?" className="text-xs font-bold text-pink-500 hover:text-pink-600 transition-colors">
                  Forgot Password?
                </Link>
              </div>
              <div className="relative">
          ...
          <p className="mt-10 text-center text-slate-500 font-medium">
            ...
            <Link to="/signup" title="Create Account" className="text-pink-500 font-bold hover:underline">
              Create Account
            </Link>
          </p>
        </div>
